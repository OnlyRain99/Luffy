...
<li class="treeview {{ ($prefix == '/employees')?'active':'' }}">
          ...
          <ul class="treeview-menu">
        <li  class="{{ ($route == 'employee.registration.view')?'active':'' }}"><a href=""><i class="ti-more"></i>Employee Registration</a></li>

         <li  class="{{ ($route == 'employee.salary.view')?'active':'' }}"><a href=""><i class="ti-more"></i>Employee Salary</a></li>
...
<li class="treeview {{ ($prefix == '/marks')?'active':'' }}">
          ...
          <ul class="treeview-menu">
        <li class="{{ ($prefix == '/marks')?'active':'' }}"><a href=""><i class="ti-more"></i>Marks Entry</a></li> 
      <li class="{{ ($route == 'marks.entry.edit')?'active':'' }}"><a href=""><i class="ti-more"></i>Marks Edit</a></li>

       <li class="{{ ($route == 'marks.entry.grade')?'active':'' }}"><a href=""><i class="ti-more"></i>Marks Grade</a></li> 
...
<li class="treeview {{ ($prefix == '/accounts')?'active':'' }}">
          ...
          <ul class="treeview-menu">
        <li class="{{ ($route == 'student.fee.view')?'active':'' }}"><a href=""><i class="ti-more"></i>Student Fee</a></li> 
        <li class="{{ ($route == 'account.salary.view')?'active':'' }}"><a href=""><i class="ti-more"></i>Employee Salary</a></li> 

        <li class="{{ ($route == 'other.cost.view')?'active':'' }}"><a href=""><i class="ti-more"></i>Other Cost</a></li>
       ...
       <li class="treeview {{ ($prefix == '/reports')?'active':'' }}">
          ...
          <ul class="treeview-menu">
        <li class="{{ ($route == 'monthly.profit.view')?'active':'' }}"><a href=""><i class="ti-more"></i>Monthly-Yearly Profite</a></li> 

          <li class="{{ ($route == 'marksheet.generate.view')?'active':'' }}"><a href=""><i class="ti-more"></i>MarkSheet Generate</a></li>

           <li class="{{ ($route == 'attendance.report.view')?'active':'' }}"><a href=""><i class="ti-more"></i>Attendance Report</a></li>

           <li class="{{ ($route == 'student.result.view')?'active':'' }}"><a href=""><i class="ti-more"></i>Student Result </a></li>

           <li class="{{ ($route == 'student.idcard.view')?'active':'' }}"><a href=""><i class="ti-more"></i>Student ID Card </a></li>    
